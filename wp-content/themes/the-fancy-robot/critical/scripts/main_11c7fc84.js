...
/******/ 	__webpack_require__.p = "/wp-content/themes/the-fancy-robot/dist/";
/******/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_custom_event_polyfill__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_intersection_observer__ = __webpack_require__(41);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_foundation_sites_js_entries_foundation__ = __webpack_require__(37);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_siema__ = __webpack_require__(45);
  ...
  finalize: function finalize() {
    ...
    if(imageGrids != undefined && imageGrids.length) {
      [].forEach.call(imageGrids, function (imageGrid) {
        ...
        prevButton.addEventListener('click', function () { return slider.prev(); })
        nextButton.addEventListener('click', function () { return slider.next(); })
    ...
    var modal = document.querySelector('#cal-modal');
    ...
    var modalButtons = document.querySelectorAll('.button.cta-modal');
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  finalize: function finalize() {
    ...
    var videoEl = document.querySelector('.hero-nav__video');
    ...
    var ctaButton = banner.querySelector('.button.cta-modal');
    if(banner && banner != undefined) {
      if(hero && hero != undefined) {


        window.addEventListener('scroll', function () {
          var scrollDistance = hero.offsetHeight * 0.75;
